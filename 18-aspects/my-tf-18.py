#!/usr/bin/env python
import sys, re, operator, string, time, types
...
#tracked_functions = ["allFunctions"]
# weaver
if "allFunctions" in tracked_functions:
    tracked_functions = [x for x in globals().values() if type(x) == types.FunctionType]
